...
function SignInPage() {
  ...
  useEffect(() => {
    if (Context.isLogin) {
      ...
      navigate('/dashboard'); // Or any other route you want
    }
  }, [Context.isLogin, Context.setAlertBox, navigate]);
        ...
        <div className="container">
          <div className="box card p-3 shadow border-0">
            <form onSubmit={Login}>
              ...
              <Button
                variant="contained w-100 mt-3 Signbtn"
                type="submit"
                disabled={isLoding}
              >
                {isLoding ? "Signing In..." : "Sign In"}
              </Button>
              ...
              <Button variant="contained w-100 mt-2 GoogltBtn">
                <FcGoogle
                  className="mr-2"
                  style={{ fontSize: "20px " }}
                />{" "}
